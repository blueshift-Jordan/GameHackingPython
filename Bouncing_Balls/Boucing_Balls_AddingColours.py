...
#A list of possible colours for our balls  
colour_list = [BLACK, WHITE, GREEN, RED, MAGENTA, BLUE]
...
class Ball:
    ...
    def __init__(self):
        ...
        self.change_x = 0
        self.change_y = 0
        self.colour = rand_colour = random.choice(colour_list)
...
def main():
    ...
    while not done:
        ...
        # Draw the balls
        for ball in ball_list:
            pygame.draw.circle(screen, ball.colour, [ball.x, ball.y], BALL_SIZE)
